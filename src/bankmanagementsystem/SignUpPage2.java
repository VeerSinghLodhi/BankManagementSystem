...
public class SignUpPage2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("648-XXX-XXX-XXX-XX");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel8.setText("XXXX");

        jLabel9.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N
        jLabel9.setText("(Your 14-digit Card number)");
    ...
    try
    {
        ...
        {
            sql1="insert into signup2 values('"+ano+"','"+cardno+"','"+pin+"','"+account_type+"','"+services_required+"')";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
              SignUpPage2 s3=new SignUpPage2(0);
               s3.setVisible(true);
